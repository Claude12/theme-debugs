...
const fileUpload = ( addToCartForm, addtoCartButton = null ) => {
	...
	const submitButton = addtoCartButton ?? form.querySelector( addtoCartButtonSelector );
