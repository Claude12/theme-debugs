...
const ExportPanel = () => {
	...
	const onSelectAll = () => {
		Array.from( document.querySelectorAll( '#wpo-export-panel input[type="checkbox"]' ), ( checkbox ) => ( checkbox.checked = true ) );
		setExportDisabled( document.querySelectorAll( '#wpo-export-panel input[type="checkbox"]:checked' ).length === 0 );
	};

	const onUnselectAll = () => {
		Array.from( document.querySelectorAll( '#wpo-export-panel input[type="checkbox"]' ), ( checkbox ) => ( checkbox.checked = false ) );
