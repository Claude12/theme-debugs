 ...
 *  accepts single argument. Object of browsers you dont want to support. Useful for overrides from function call
 */
class BrowserDetector {
  constructor(unsupported = {}) {
    ...
    this.unsupportedBrowsers = Object.assign(
      {},
      this.defaultsBrowsers,
      unsupported
    );
  ...
  /**
   *  Retrieve list of unsupportedBrowsers ( > value ) is not supported
   * @returns {Object}
   */
  ...
  /**
   * Shows information available to you
   */
  get showInfo() {
    const result = [
      {
