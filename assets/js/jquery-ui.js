...
(function ( factory ) {
	...
	*/
	...
	$.fn.extend(
		...
		disableSelection: (function () {
			...
			return function () {
				return this.bind(
					eventType + ".ui-disableSelection", function ( event ) {
	...
	*/
	...
	$.widget = function ( name, base, prototype ) {
		...
		if (existingConstructor ) {
			$.each(
				existingConstructor._childConstructors, function ( i, child ) {
	...
	$.each(
		{ show: "fadeIn", hide: "fadeOut" }, function ( method, defaultEffect ) {
		...
		"ui.menu", {
			...
			nextPage: function ( event ) {
				...
				if (this._hasScroll() ) {
					...
					this.focus(
						event, this.activeMenu.find(this.options.items)
		...
		"ui.draggable", $.ui.mouse, {
			...
			_mouseStop: function (event) {
				...
				if ((this.options.revert === "invalid" && !dropped) || (this.options.revert === "valid" && dropped) || this.options.revert === true || ($.isFunction(this.options.revert) && this.options.revert.call(this.element, dropped))) {
					$(this.helper).animate(
						this.originalPosition, parseInt(this.options.revertDuration, 10), function () {
	...
	*/
	$.ui.ddmanager = {
		...
		drop: function ( draggable, event ) {
			...
			$.each(
				( $.ui.ddmanager.droppables[ draggable.options.scope ] || [] ).slice(), function () {
		...
		drag: function ( draggable, event ) {
			...
			$.each(
				$.ui.ddmanager.droppables[ draggable.options.scope ] || [], function () {
	...
	*/
	(function ( jQuery, undefined ) {
		...
		each(
			spaces, function ( spaceName, space ) {
		...
		function stringParse( string )
		{
			...
			each(
				stringParsers, function ( i, parser ) {
					var parsed,
		...
		color.fn                 = jQuery.extend(
			color.prototype, {
				parse: function ( red, green, blue, alpha ) {
					...
					if (type === "array" ) {
						each(
							spaces.rgba.props, function ( key, prop ) {
				...
				is: function ( compare ) {
					...
					each(
						spaces, function ( _, space ) {
							var localCache,
							isCache = is[ space.cache ];
							if (isCache) {
								localCache = inst[ space.cache ] || space.to && space.to(inst._rgba) || [];
								each(
									space.props, function ( _, prop ) {
			...
			return this.queue(
				function () {
					...
					applyClassChange = function () {
						$.each(
							classAnimationActions, function (i, action) {
								if (value[ action ] ) {
...
***********************************/
	...
	(function () {
		...
		$.each(
			baseEasings, function ( name, easeIn ) {
		...
		if (scale === "content" || scale === "both" ) { // Scale the children
			...
			el.find("*[width]").each(
				function () {
					...
					child.animate(
						child.to, o.duration, o.easing, function () {
	...
	var effectTransfer = $.effects.effect.transfer = function ( o, done ) {
		var elem          = $(this),
			...
			transfer      = $("<div class='ui-effects-transfer'></div>")
				...
				.animate(
					animation, o.duration, o.easing, function () {
						transfer.remove();
						done();
					}
				);
		...
		_create: function () {
			...
			refresh: function () {
				...
				options.disabled = $.map(
					lis.filter(".ui-state-disabled"), function ( tab ) {
			...
			_processTabs: function () {
				...
				this.tablist = this._getList()
					...
					.delegate(
						"> li", "mousedown" + this.eventNamespace, function ( event ) {
					...
					// the body anyway.
					.delegate(
						".ui-tabs-anchor", "focus" + this.eventNamespace, function () {
			...
			_toggle: function ( event, eventData ) {
				...
				if (toHide.length && this.options.hide ) {
					this._hide(
						toHide, this.options.hide, function () {
	...
	var tooltip = $.widget(
		"ui.tooltip", {
			...
			close: function ( event ) {
				...
				tooltip.stop(true);
				this._hide(
					tooltip, this.options.hide, function () {
