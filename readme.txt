...
* Fix: Options missing when variation products are added to the cart
* Fix: Options missing when lazy-loading is active in WooCommerce Product Table
* Fix: Ignore main product price being disregarded in price formulas
* Fix: DB not being updated under certain conditions
* Tweak: Improved cart update logic when using bundle-like behavior
* Tweak: Improved layout of choice settings, restrictions and quantity limits
* Dev: Tested up to WordPress 6.9.1 and WooCommerce 10.5.2

= 2.6.2 =
Release date 22 January 2026

* Fix: Plugin integrations not working as expected
* Fix: Checkout link table not being created in new installations
* Fix: Fatal error being thrown when placing order under certain conditions
* Tweak: Improved DB query optimizations
* Tweak: Other minor styling improvements

= 2.6.1 =
Release date 15 January 2026

* Fix: DB not being updated correctly in some cases

= 2.6.0 =
Release date 15 January 2026

* New: Added quantity pickers to multi-choice options
* New: Added support for checkout links
* New: Added option setting to hide option prices
* New: Added role-based options
* New: Added price display setting to option groups
* Tweak: Addon products are added to the cart after the main product
* Tweak: Addon products are removed with the related main product
* Tweak: Improved integration with WPML
* Tweak: Improved compatibility with supported themes
* Tweak: Optimized interaction with database
