...
if ( ! isset( $afrfq_custom_button_text ) || empty( $afrfq_custom_button_text ) ) {
	$afrfq_custom_button_text = __( 'Add to Quote', 'addify_b2b' );
}
...
<div class="woocommerce-variation-add-to-cart variations_button">
	...
	echo '<a href="javascript:void(0)" rel="nofollow" data-rule_id="' . esc_attr($applied_rule_id) . '" data-product_id="' . intval( $product->get_ID() ) . '" data-product_sku="' . esc_attr( $product->get_sku() ) . '" class="afrfqbt_single_page button single_add_to_cart_button alt product_type_' . esc_attr( $product->get_type() ) . '">' . esc_attr( $afrfq_custom_button_text ) . '</a>';
