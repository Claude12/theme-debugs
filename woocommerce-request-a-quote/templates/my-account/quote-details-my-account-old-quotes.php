...
?>
<h2 class="entry-title"><?php echo esc_html__( 'Quote ', 'addify_b2b' ); ?><?php echo esc_html__( '#', 'addify_b2b' ) . intval( $afrfq_id ); ?></h2>

<p><?php echo esc_html__( 'Quote ', 'addify_b2b' ); ?> <?php echo esc_html__( '#', 'addify_b2b' ); ?><mark class="order-number"><?php echo intval( $afrfq_id ); ?></mark> <?php echo esc_html__( ' was placed on ', 'addify_b2b' ); ?> <mark class="order-date"><time datetime="<?php echo esc_attr( gmdate( 'Y-m-d', strtotime( $quote->post_date ) ) ); ?>" title="<?php echo esc_attr( strtotime( $quote->post_date ) ); ?>"><?php echo esc_attr( date_i18n( get_option( 'date_format' ), strtotime( $quote->post_date ) ) ); ?></time></mark>.</p>
...
<table class="shop_table order_details">
	...
	<tr>
		<th></th>
		<th class="product-name"><?php echo esc_html__( 'Product', 'addify_b2b' ); ?></th>
		<th class="product-sku"><?php echo esc_html__( 'SKU', 'addify_b2b' ); ?></th>
		<th class="product-total"><?php echo esc_html__( 'Quantity', 'addify_b2b' ); ?></th>
	</tr>
	</thead>
	<tbody>
		<?php
