...
class AF_R_F_Q_Rest_Rules_Controller extends WC_REST_CRUD_Controller {
	...
	public function get_rule_data( $object, $context, $request ) {
		...
		$rule_data['brands']               = get_post_meta( $object->get_id(), 'afrfq_hide_brands', true );
		$rule_data['popup_enabled']        = get_post_meta( $object->get_id(), 'afrfq_enable_add_to_quote_popup', true);
		$rule_data['apply_all_user_roles'] = get_post_meta( $object->get_id(), 'afrfq_apply_on_all_user_role', true );
	...
	public function get_item_schema() {
		...
		$schema = array(
			...
			'properties' => array(
				...
				'priority'            => array(
					'description' => __( 'Rule Priority.', 'addify_b2b' ),
					'type'        => 'integer',
					'context'     => array( 'view', 'edit' ),
				),
				'date_created'        => array(
				...
				'all_products'        => array(
					'description' => __( 'Is rule applies on all products.', 'addify_b2b' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'products'            => array(
					'description' => __( 'Rules applies on products.', 'addify_b2b' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'categories'          => array(
					'description' => __( 'Rule applies on categories.', 'addify_b2b' ),
					'type'        => 'array',
					'context'     => array( 'view', 'edit' ),
				),
				'user_roles'          => array(
					'description' => __( '.', 'addify_b2b' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'hide_price'          => array(
					'description' => __( 'Is price of product is hidden?', 'addify_b2b' ),
					'type'        => 'bool',
					'context'     => array( 'view', 'edit' ),
				),
				'hide_price_text'     => array(
					'description' => __( 'Text to replace add price of products.', 'addify_b2b' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'hide_addtocart'      => array(
					'description' => __( 'Is add to cart button hidden?', 'addify_b2b' ),
					'type'        => 'bool',
					'context'     => array( 'view', 'edit' ),
				),
				'hide_addtocart_text' => array(
					'description' => __( 'Text to replace add to cart button.', 'addify_b2b' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'contact_7_form'      => array(
					'description' => __( 'contact 7 form ID.', 'addify_b2b' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
				'custom_button_link'  => array(
					'description' => __( 'Link for custom button.', 'addify_b2b' ),
					'type'        => 'string',
					'context'     => array( 'view', 'edit' ),
				),
