		...
		<?php if ( ! empty( $post->ID ) ) : ?>
			<tr class="addify-option-field">
				<th>
					<div class="option-head">
						<h3>
							<?php echo esc_html__( 'Quote ID:', 'addify_b2b' ); ?>
						</h3>
					</div>
				</th>
				<td>
			...
			<tr class="addify-option-field">
				<th>
					<div class="option-head">
						<h3>
							<?php echo esc_html__( 'Quote User:', 'addify_b2b' ); ?>
						</h3>
					</div>
				</th>
				<td>
					...
					switch ( $afrfq_field_type ) {
						...
						case 'file':
							if ( ! empty( $field_data ) && file_exists( AFRFQ_UPLOAD_DIR . $field_data ) ) {
								...
								if ( in_array($extension, array( 'csv', 'docx', 'zip' ))) {
									?>
									<a href="<?php echo esc_url( AFRFQ_UPLOAD_URL . $field_data ); ?>" class="adf-edit-file"><?php echo esc_html__( 'View file', 'addify_b2b' ); ?></a>
									<?php
								} else {
									?>
								...
								?>
									<p><?php echo esc_html__( 'No file was uploaded by user.', 'addify_b2b' ); ?></p>
								<?php
							}
							break;
						case 'textarea':
						...
						case 'checkbox':
							...
							$value = strtolower( trim( $option ) );
								?>
							<input placeholder="<?php echo esc_html( $afrfq_field_placeholder ); ?>" type="checkbox" name="<?php echo esc_html( $afrfq_field_name ); ?>[]" value="<?php echo esc_html( $value ); ?>" <?php echo checked( in_array( $value, (array) $field_data ), true ); ?> >
