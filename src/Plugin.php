...
class Plugin extends Premium_Plugin {
	...
	public function add_services() {
		...
		if ( $this->get_license()->is_valid() ) {
			...
			// Handler services
			$this->add_service( 'handlers/product_cache', new Handlers\Product_Cache() );
			...
			$this->add_service( 'handlers/checkout_links', new Handlers\Checkout_Links() );
			...
			$this->add_service( 'integration/wqm', new Integration\Quantity_Manager() );
