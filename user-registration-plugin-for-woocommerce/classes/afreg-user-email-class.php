...
if ( !class_exists( 'Addify_Registration_Fields_User_Email' ) ) { 
	...
	class Addify_Registration_Fields_User_Email extends WC_Email {
		...
		public function __construct() { 
			...
			$this->title          = __( 'Addify Registration New User Email to Customer', 'addify_b2b' ); // Title of email to show in Settings
			$this->customer_email = true; // Set true for customer email and false for admin email.
			$this->description    = __( 'This email will be sent to customer when new account is created.', 'addify_b2b' ); // description of email
		...
		public function get_default_subject() {
			...
			return __( 'Your {site_title} account has been created!', 'addify_b2b' );
		}
